...
class core:
	...
	def cor(self):
		cor = ro.r("""
			...
			resultfit = cor(x=dataset$mpg,y=dataset$disp)
	        	saveRDS(resultfit, file ="/home/espe/openccml/models/cor.rds")
	...
	def arima(self):
		arima = ro.r("""
			...
			saveRDS(resultfit, file ="/home/espe/openccml/models/arima.rds")
	...
	def autoarima(self):
		autoarima = ro.r("""
			...
			saveRDS(resultfit, file ="/home/espe/openccml/models/autoarima.rds")
	...
	def ets(self):
		ets = ro.r("""
			...
			saveRDS(resultfit, file ="/home/espe/openccml/models/ets.rds")
	...
	def rf(self):
		rf = ro.r("""
			...
			r2pmml(resultfit, file ="/home/espe/openccml/pmmls/rf.pmml")
			saveRDS(resultfit, file ="/home/espe/openccml/models/rf.rds")
	...
	def svm(self):
		svm = ro.r("""
			...
			saveRDS(resultfit, file ="/home/espe/openccml/models/svm.rds")
	...
	def stl(self):
		stl = ro.r("""
			...
			plot(model)
			dev.off()
			saveRDS(model, file ="/home/espe/openccml/models/stl.rds")
	...
	def nnet(self):
		nnet = ro.r("""
			...
			saveRDS(model, file ="/home/espe/openccml/models/nnet.rds")
	...
	def neuralnet(self):
		neuralnet = ro.r("""
			...
			saveRDS(model, file ="/home/espe/openccml/models/neuralnet.rds")
	...
	def rbf(self):
		rbf = ro.r("""
			...
			dev.off()
			plotIterativeError(model)			
			saveRDS(model, file ="/home/espe/openccml/models/rbf.rds")
	...
	def mlp(self):
		mlp = ro.r("""
			...
			dev.off()
			plotIterativeError(model)			
			saveRDS(model, file ="/home/espe/openccml/models/mlp.rds")
	...
	def predict(self):
		predict = ro.r("""	
			...
			saveRDS(resultfit, file ="/home/espe/openccml/models/predict.rds")	
	...
	def predictarima(self):
		predictarima = ro.r("""	
			...
			saveRDS(model, file ="/home/espe/openccml/models/arima.rds")
			print(model)
			resultfit = predict(model,n.ahead=12)	
			saveRDS(resultfit, file ="/home/espe/openccml/models/predictarima.rds")	
	...
	def predictlm(self):
		predictlm = ro.r("""	
			...
			saveRDS(model, file ="/home/espe/openccml/models/lm.rds")
			print(model)
			resultfit = predict(model)	
			saveRDS(resultfit, file ="/home/espe/openccml/models/predictlm.rds")
	...
	def predictRF(self):
		predictRF = ro.r("""
			...
			saveRDS(model, file ="/home/espe/openccml/models/rf.rds")
			print(model)
			resultfit = predict(model)	
			saveRDS(resultfit, file ="/home/espe/openccml/models/predictRF.rds")
	...
	def predictMLP(self):
		predictMLP = ro.r("""
			...
			print(model)
			resultfit = predict(model)	
			saveRDS(resultfit, file ="/home/espe/openccml/models/predictMLP.rds")
	...
	def predictETS(self):
		predictETS = ro.r("""
			...
			dataset=dataset[,1]
	        	model = ets(y=dataset)
			saveRDS(model, file ="/home/espe/openccml/models/ets.rds")
			print(model)
			resultfit = predict(model)	
			saveRDS(resultfit, file ="/home/espe/openccml/models/predictETS.rds")
	...
	def predictRBF(self):
		predictRBF = ro.r("""
			...
			print(model)
			resultfit = predict(model)	
			saveRDS(resultfit, file ="/home/espe/openccml/models/predictRBF.rds")
	...
	def predictSVM(self):
		predictSVM = ro.r("""
			...
			saveRDS(model, file ="/home/espe/openccml/models/svm.rds")
			capture.output(model, file ="svm.txt")
			print(model)
			resultfit = predict(model)	
			saveRDS(resultfit, file ="/home/espe/openccml/models/predictSVM.rds")
	...
	def predictnnet(self):
		predictnnet = ro.r("""
			...
			print(model)
			resultfit = predict(model)	
			saveRDS(resultfit, file ="/home/espe/openccml/models/predictnnet.rds")
